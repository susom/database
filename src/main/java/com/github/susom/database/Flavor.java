...
public enum Flavor {
  derby {
    ...
    @Override
    public String typeLongIdentity() {
  ...
  bigquery {
    ...
    @Override
    public String typeLongIdentity() {
      throw new UnsupportedOperationException("BigQuery does not support identity columns");
    }
 ...
 */
  ...
  /**
   * Return the DDL syntax for creating an identity column for the Long type.
   * For example, PostgreSQL uses "bigint generated by default as identity",
   * SQL Server uses "bigint identity(1,1)", etc.
   */
  public abstract String typeLongIdentity();

  /**
   * Return true if this database supports identity columns and can return
   * generated keys from insert statements.
   */
